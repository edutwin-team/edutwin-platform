...
export const resultsPageData: ResultsPageData = {
  ...
  kpis: {
    successRate: {
      ...
      description:
        'Résultat stable, avec une meilleure performance sur les questions d’application.',
      progress: 81,
    },
    acquiredSkills: {
      ...
      description:
        'Les bases sont maîtrisées. Les compétences avancées demandent encore de la consolidation.',
    ...
    improvementTracks: {
      ...
      description:
        'Renforcer la précision des réponses et la gestion du temps sur les items complexes.',
    },
  },
  feedbackBlocks: [
    {
      title: 'Forces',
      description:
        'Bonne compréhension des consignes et raisonnement structuré sur la majorité des questions.',
    },
    {
      title: 'Points à renforcer',
      description:
        'Travailler la justification des réponses et la relecture avant validation finale.',
    },
    {
      title: 'Recommandation',
      description:
        'Proposer un entraînement ciblé de 20 minutes sur les compétences non encore stabilisées.',
    },
  ],
  recommendations: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          action:
            "Programmer une session d'entraînement en temps contraint avec correction guidée.",
        },
      ],
    },
    {
