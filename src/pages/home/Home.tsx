  ...
  const recommendation = useMemo(() => {
    ...
    if (focus === "attention") {
      return {
        ...
        description:
          "Run a short scenario with engagement checkpoints every 10 minutes.",
    ...
    return {
      ...
      description:
        "Identify fragile concepts before class and improve your content immediately.",
    ...
    <div className="home-shell flex min-h-[calc(100vh-64px)] flex-col justify-between text-white">
      <main className="mx-auto mt-8 flex w-full max-w-6xl flex-col px-6 md:mt-10">
        <section ref={quizSectionRef} className="w-full border-t border-white/10 pt-8 md:pt-10">
          ...
          <progress className="progress progress-primary mb-6 h-2 w-full" value={progress} max={100}></progress>
        ...
        <section className="mt-12 border-t border-white/10 pt-10 lg:grid lg:grid-cols-[1.15fr_0.85fr] lg:gap-12">
          <div className="p-1 md:p-2 lg:max-w-3xl">
            ...
            <div className="mt-6 border-l-2 border-indigo-300/40 pl-4">
              <div className="mb-5">
                <p className="text-xs uppercase tracking-wide text-indigo-300">1. Detected risk</p>
                <p className="mt-1 text-sm text-slate-200 md:text-base">
                  EduTwin identifies your most fragile point first (attention, comprehension, or inclusion).
                </p>
              </div>
              <div className="mb-5">
                <p className="text-xs uppercase tracking-wide text-indigo-300">2. Recommended action</p>
                <p className="mt-1 text-sm text-slate-200 md:text-base">
                  You receive a practical next step directly linked to your classroom objective.
                </p>
              </div>
              <div>
                <p className="text-xs uppercase tracking-wide text-indigo-300">3. Ready-to-use output</p>
                <p className="mt-1 text-sm text-slate-200 md:text-base">
          ...
          <div className="mt-8 p-1 md:p-2 lg:mt-0 lg:sticky lg:top-24">
            ...
            <div className="mt-4 rounded-xl border border-white/10 bg-white/5 p-4">
              ...
              <progress className="progress progress-primary mt-2 h-1.5 w-full" value={confidenceScore} max={100}></progress>
            ...
            {answerSummary.length > 0 ? (
              ...
              <p className="mt-4 text-sm text-slate-300">
                Start the QCM to see your path here.
              </p>
            )}
            <p className="mt-4 text-xs text-slate-300">
              Next best action: <span className="font-semibold text-slate-100">{recommendation.primaryCta}</span>
            </p>
          </div>
          </section>
